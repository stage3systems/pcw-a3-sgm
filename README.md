...
You'll need to add entries to your `/etc/hosts` file to access the service, e.g. `127.0.0.1 localhost sgmtest.pcw.a3`

After that you'll be able to access the service at http://sgmtest.pcw.a3:3000
