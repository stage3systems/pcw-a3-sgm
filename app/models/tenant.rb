class Tenant < ActiveRecord::Base
  ...
  def uses_new_da_sync?
    ["sgm", "biehl", "nabsa", "argelan", "marval", "robertreford", "mta", "benline", "fillettegreen", "seaforth", "normac", "wallem", "wallemgroup", "tormarshipping", "hbm", "a3demo"].member? self.customer_name
  end
