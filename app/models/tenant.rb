class Tenant < ActiveRecord::Base
  ...
  def uses_new_da_sync?
    ["sgm", "biehl", "nabsa", "argelan", "marval", "robertreford", "mta", "benline", "fillettegreen", "seaforth", "normac", "tormarshipping", "a3demo"].member? self.customer_name
  end
  ...
  def sync_port_with_office(portId, officeId)
      ...
      return false if aos_port.nil? or aos_office.nil?
