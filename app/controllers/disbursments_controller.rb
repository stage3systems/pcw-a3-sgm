class DisbursmentsController < ApplicationController
  ...
  def format_published_pdf
    ...
    @pdf.text "Dowload the full <link href=\"https://monson-disbursments.evax.fr/MAA%20Standard%20Terms%20and%20Conditions%20Sep%202012.pdf\">Terms and Conditions</link>", inline_format: true
  end
