...
class DisbursementRevisionTest < ActiveSupport::TestCase
  ...
  test "sync with aos" do
    ...
    stub_request(:post, "https://test:test@test.agencyops.net/api/v1/save/disbursement").
      with(:body => "{\"id\":1,\"code\":\"MNL\",\"appointmentId\":null,\"nominationId\":1,\"payeeId\":321,\"creatorId\":1,\"modifierId\":1,\"grossAmount\":\"1100.0\",\"netAmount\":\"1000.0\",\"estimateId\":675045400,\"estimatePdfUuid\":\"id2\",\"description\":\"Marine Levy\",\"status\":\"INITIAL\",\"reference\":\"reference2\",\"sort\":1,\"taxApplies\":true,\"comment\":\"Comment for Marine Levy\"}",
